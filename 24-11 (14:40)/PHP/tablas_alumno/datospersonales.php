...
<?php if ($_SESSION['tipoUsuario']!="alumno") {
    ...
    <div class="todo">
            <form id="datosPersonales" action="datos-personales-alumno" method="post" class="formulariodatos" enctype="multipart/form-data">
               

                <label for="imagenInput" id="perfil-icon">
                    <img id="imagenMostrada" src="data:image/jpeg;base64,' . $foto_base64 . '"  style="max-width: 300px; max-height: 300px;">
                </label>
...
<script>
        // JavaScript para activar el input de tipo "file" al hacer clic en el icono de perfil
