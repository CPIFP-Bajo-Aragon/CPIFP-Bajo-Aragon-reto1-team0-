...
// Función para borrar el registro de una empresa
    ...
    //         // Intenta eliminar el registro de la tabla 'empresa' usando el ID de usuario
    //         $sql_empresa = "DELETE FROM empresa WHERE id_usuario = :id_usuario";
    //         $consulta_empresa = $conexion->prepare($sql_empresa);
    //         $consulta_empresa->bindParam(':id_usuario', $id_usuario);
...
//Funcion para insertar empresas
    function insertarempresaadmin($conexion){
            ...
            $sql = "INSERT INTO `usuario`( `nombre_usuario`, `password`, `correo`, `validado`, `tipo`) VALUES ('$nombre_usuario','$contrasena','$email','$validado','$tipo');";
