...
<body>
    ...
    <?php
     if(isset($_POST['insertarempresa'])){
        echo "Formulario de empresa enviado";
...
?>
        <form action="registrar" method="POST" id="miFormulario">
            ...
            <div id="empresa">
                ...
                <input type="number" id="telefono" name="telefono" maxlength="9" placeholder="TELEFONO">

                <label for="">POBLACION</label>
                <input type="text" id="poblacion" name="poblacion" maxlength="50" placeholder="POBLACION">

                <label for="">SECTOR</label>
                <input type="text" id="sector" name="sector" maxlength="50" placeholder="SECTOR">

                
                <input type="submit" name="insertarempresa" id="insertarempresa" value="insertarempresa">
            </div>
            ...
            <div id="alumno">
                ...
                <input type="text" id="apellido" name="apellido" maxlength="50"  placeholder="apellido">
                ...
                <input type="checkbox" id="conducir" name="conducir"  placeholder="conducir">
                ...
                <input type="submit" name="insertaralumno" id="insertaralumno" value="insertaralumno">
            </div>
        </form>
