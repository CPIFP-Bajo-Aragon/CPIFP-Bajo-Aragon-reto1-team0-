...
<script>
    ...
    sections.forEach(section => {
        ...
        const content = section.querySelector('.detalles');
...
radioButtons.forEach(function (radio) {
    ...
    radio.addEventListener('change', function () {
        ...
        // Obtiene todas las ofertas en la tabla
        const ofertas = document.querySelectorAll('.oferta');

        // Itera sobre cada oferta para aplicar el filtro
        ofertas.forEach(function (oferta) {
            // Obtiene el contenido del elemento con la clase 'carnet_conducir'
            const carnetConducirElement = oferta.querySelector('.carnet_conducir');
            // Obtiene el texto dentro del elemento
            const columnaCarnet = carnetConducirElement.textContent.trim();

            // Muestra la oferta si coincide con el filtro, oculta si no coincide
            if (filtro === 'todos' || columnaCarnet === (filtro === 'conCarnet' ? 'Si' : 'No')) {
                oferta.style.display = ''; // Muestra la oferta si coincide con el filtro.
            } else {
                oferta.style.display = 'none'; // Oculta la oferta si no coincide con el filtro.
            }
...
inputDuracionContrato.addEventListener('input', function () {
 ...
 ofertas.forEach(function (oferta) {
      let columnaDuracion = parseInt(oferta.querySelector('.duracion_contrato').textContent);
