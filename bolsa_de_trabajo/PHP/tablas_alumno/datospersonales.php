...
<body>
    ...
    <main class="maindatopersonales">
        ...
        <h1 class="tituloeditar">MODIFICAR DATOS PERSONALES: </h1>  

        <div class="editardatos">
                <form id="datosPersonalesalumno" action="datos-personales-alumno" method="post" class="formulariodatos" enctype="multipart/form-data">
