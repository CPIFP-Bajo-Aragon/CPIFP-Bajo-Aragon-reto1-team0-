...
document.querySelectorAll('[name="editar"]').forEach(function (button) {
    button.addEventListener('click', function (event) {
        ...
        var labelnombreusuario = document.createElement('label');
        labelnombreusuario.textContent = 'Nombre Usuario';

        var labelnombre = document.createElement('label');
        labelnombre.textContent = 'Nombre';

        var labelcif = document.createElement('label');
        labelcif.textContent = 'CIF';
        ...
        form.appendChild(labelnombreusuario);
        form.appendChild(inputNombreUsuario);
        form.appendChild(labelnombre);
        form.appendChild(inputNombre);
        form.appendChild(labelcif);
