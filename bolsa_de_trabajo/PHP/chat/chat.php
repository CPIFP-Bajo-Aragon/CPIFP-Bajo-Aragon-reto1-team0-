...
<head>
    ...
    <?php
        ...
        function listarmensajes($conexion, $id_receptor, $id_usuario) {
            ...
            $sql = "SELECT * FROM mensaje WHERE (id_usuario = :id_usuario AND receptor = :id_receptor) OR (id_usuario = :id_receptor AND receptor = :id_usuario) ORDER BY fecha";
            ...
            while ($fila = $consulta->fetch(PDO::FETCH_OBJ)) {
                ...
                if($fila->id_usuario===$id_usuario && $fila->receptor===$id_receptor){
                    echo "<div class='enviado' value=".$fila->receptor.">" . $fila->mensaje . "</div>";
                }else{
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        messages.forEach(function (message) {
            ...
            // Verifica si el mensaje tiene la clase 'received'
                ...
                message.style.backgroundColor = 'red'; // verde más claro para mensajes recibidos
