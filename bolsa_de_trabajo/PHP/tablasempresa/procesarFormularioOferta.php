        ...
        if (isset($_POST['Enviar'])) {
            ...
            if ($stmtOferta->execute()) {
                ...
                foreach ($_POST["idiomas"] as $key => $idioma) {
                    $nivel_idioma = $_POST["niveles_idioma"][$key];
                    $query_idiomas = "INSERT INTO solicita_hablar_idioma (id_oferta, id_idioma, id_nivel) VALUES (:id_oferta, :idioma, :nivel_idioma)";
                    $stmt_idiomas = $conexion->prepare($query_idiomas);
                    $stmt_idiomas->bindParam(':id_oferta', $id_oferta);
                    $stmt_idiomas->bindParam(':idioma', $idioma);
                    $stmt_idiomas->bindParam(':nivel_idioma', $nivel_idioma);
