        ...
        if(isset($_POST['insertoferta'])){
           ...
           // Inserta en la tabla 'pide_tener_estudio'
            ...
            if (!empty( $_SESSION['experiencia'])) {
                foreach ( $_SESSION['experiencia'] as $id_oficio) {
                    $sqlExperiencia = "INSERT INTO pedir_experiencia (id_oficio, id_oferta, meses_experiencia) VALUES (:id_oficio, :id_oferta, :meses_experiencia)";
                    $stmtExperiencia = $conexion->prepare($sqlExperiencia);
                    $stmtExperiencia->bindParam(':id_oficio', $id_oficio);
                    $stmtExperiencia->bindParam(':id_oferta', $id_oferta);
                    $stmtExperiencia->bindParam(':anos_experiencia', $anos_experiencia); // Asegúrate de tener esta variable
